...
export default {
  ...
  // },
  // saveLoginPass(payload) {
    // return axios.post('/saveloginpass', payload)
  // },
  // refreshToken() {
    // return axios.get('/token')
  // },
  // entityToken(tin, type) {
    // return axios.get(`/token/${tin}/${type}`)
  // },
  // getAuthId(serialNumber) {
    // return axios.get(`/authId/${serialNumber}`)
  // }
}
